...
const validateAISettings = [
  ...
  body('booking_link').optional().isURL().withMessage('Invalid booking URL'),
...
const validateBrandSettings = [
  ...
  body('n8n_webhook_url').optional().isURL().withMessage('Invalid webhook URL'),
...
const validateCreateClient = [
  ...
  body('plan_name').optional().isIn(['free_trial', 'trial', 'silver', 'gold', 'diamond', 'platinum', 'enterprise']),
...
const validateChangePlan = [
  body('plan_name').isIn(['free_trial', 'trial', 'silver', 'gold', 'diamond', 'platinum', 'enterprise']).withMessage('Invalid plan'),
  handleValidationErrors,
];
